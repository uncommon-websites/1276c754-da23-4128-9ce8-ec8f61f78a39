		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
			...
			<div class="lg:col-span-2">
				<a href="/" class="flex items-center gap-2 mb-8">
					...
					<span class="text-2xl font-serif tracking-tight font-medium">Company</span>
				</a>
                
                <div class="mt-20">
                    <a href="#" class="text-sm font-medium border-b border-white pb-1 hover:opacity-80 transition-opacity inline-block">Join our founder community</a>
                    <div class="text-[10px] text-gray-500 mt-4">© Company 2025</div>
                </div>
			</div>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					...
					<li><a href="#" class="hover:text-white transition-colors">Workflow capture</a></li>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					...
					<li><a href="#" class="hover:text-white transition-colors">Founder Community</a></li>
